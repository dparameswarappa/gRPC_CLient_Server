...
func (Syntax) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (Field_Kind) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 0} }
...
func (Field_Cardinality) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{1, 1} }
...
func (*Type) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*Field) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (*Enum) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*EnumValue) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
func (*Option) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{4} }
...
func init() { proto.RegisterFile("google/protobuf/type.proto", fileDescriptor2) }
